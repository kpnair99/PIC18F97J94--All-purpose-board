...
void main(void) {
    ...
    TRISGbits.TRISG3 = 0;
    LATGbits.LATG3 = 0;
    uint8_t who_am_i = LIS_ReadRegister(0x0F);

    LIS_WriteRegister(0x20, 0x27);
    _delay((unsigned long)((10)*(8000000UL/4000.0)));

        int8_t x = LIS_ReadAxis(0x29);
        int8_t y = LIS_ReadAxis(0x2B);
        int8_t z = LIS_ReadAxis(0x2D);
# 187 "accelarometer.c"
}
