 ...
 * Author: AG
 *
 * Created on 30 June, 2025, 4:47 PM
 */
...
#define RED_LAT LATKbits.LATK7
#define RED_TRIS TRISKbits.TRISK7

#define GREEN_LAT LATGbits.LATG6
#define GREEN_TRIS TRISGbits.TRISG6

#define BLUE_LAT LATDbits.LATD1
#define BLUE_TRIS TRISDbits.TRISD1

void init_RGB_pins(void);
void RGB_sequence(void);

void init_RGB_pins()
{
    //Disable Analog functionality of the ports
    ANCON1 = 0x00;
    ANCON2 = 0x00;
    ANCON3 = 0x00;
